...
class WeiBo():
    def __init__(self,username,password):
        ...
        self.session.check = {
            ...
            'Host': 'weibo.com',
            'Referer': 'https://weibo.com/p/1008083508b653c61b7212de392d3b67cc14a3/super_index',
                                }
    ...
    def checkin(self):
        url = 'https://weibo.com/p/aj/general/button?ajwvr=6&api=http://i.huati.weibo.com/aj/super/checkin&texta=%E7%AD%BE%E5%88%B0&textb=%E5%B7%B2%E7%AD%BE%E5%88%B0&status=0&id=1008083508b653c61b7212de392d3b67cc14a3&location=page_100808_super_index&__rnd=1547168757225'
        res = self.session.get(url=url)
        print(res.json())

if __name__ == '__main__':
    username = '13968803735'
    password = '13868753814'
